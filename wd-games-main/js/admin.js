document.addEventListener('DOMContentLoaded', () => {
    ...
    function createAdminTableRow(game, originalIndex) {
    ...
    function renderAdminTable(append = false) {
        ...
        pageData.forEach((game) => {
            ...
            adminTableBody.appendChild(createAdminTableRow(game, originalIndex));
        });
    ...
    function deleteGame(index) {
        ...
        const confirmMessage = `Peringatan: Apakah Anda yakin ingin menghapus game "${game.title}" secara LOKAL? (Klik "Simpan ke GitHub" untuk menerapkan ke server)`;
    ...
    function openGameModal(index = -1) {
        ...
        setOverlayState(gameModal, true);
    }

    function closeModal() {
        setOverlayState(gameModal, false);
    }
